...
$(function () {
    ...
    chatHub.client.pinMessage = function (messageView) {
        console.log("Poruka je pinovana");
    ...
    chatHub.client.getProfileInfo = function (userId, userName, displayName, avatar, status) {
    ...
    Model.prototype = {
        ...
        joinRoom: function (room) {
            ...
            if (room) {
                ...
                $("input#iRoom").val("Soba ");
                $("#joinedRoom").html("<b>" + "Soba" + "</b>");
            }
        ...
        createRoom: function () {
            ...
            if (name != null && name != "") {
                ...
                console.log("Soba je napravljena!");
            }
            ...
            if (self.chatUsers().length > 0) {
                for (var i = 0; i < self.chatUsers().length; i++) {
                    if (self.chatUsers()[i].id() == user.id) {
                        self.chatUsers()[i].Online(user().Online);
                        self.forceUpdate("1");
        ...
        userUpdatedOnline: function (id, Online) {
            var self = this;
            console.log("update");
            ...
            if (self.chatUsers().length > 0) {
                for (var i = 0; i < self.chatUsers().length; i++) {
                    ...
                    if (self.chatUsers()[i].id() == id) {
                        self.chatUsers()[i].Online(Online);
                        self.forceUpdate("1");
                        console.log(self.forceUpdate());
                        break;
                    }
    ...
    //Funkcija $data koja je povezana sa userList funkcijom
    function ChatUser(id = null, userName, displayName, avatar, currentRoom, device, Online, Primer, roomRole = null) {
        var self = this;
        ...
        self.Primer = ko.observable(Primer);
