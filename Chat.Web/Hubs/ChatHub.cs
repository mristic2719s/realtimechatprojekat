...
namespace Chat.Web.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public void AddUserToRoom(string userId, int roomId, int role = 0)
        {
            ...
            {
                Clients.Caller.onError("Nemoguće je kreirati sobu: " + ex.Message);
            }
        }
        ...
        public override Task OnConnected()
        {
            ...
            using (var db = new ApplicationDbContext())
            {
                ...
                if (_Users.Count == 0)
                {
                    //Dodavanje postojecih korisnika u listu
        ...
        public override Task OnDisconnected(bool stopCalled)
        {
            ...
            {
                Clients.Caller.onError("Diskonekcija: " + ex.Message);
            }
        ...
        public override Task OnReconnected()
        {
            ...
            var user = _Connections.Where(u => u.UserName == IdentityName).FirstOrDefault();
            Clients.Caller.getProfileInfo(user.Id, user.DisplayName, user.Avatar,user.Online);
